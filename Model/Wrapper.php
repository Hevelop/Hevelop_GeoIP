...
class Wrapper
{
     ...
     * @var array
     */
    protected $GEOIP_COUNTRY_CODE_TO_NUMBER = [
     ...
     * @var array
     */
    protected $GEOIP_COUNTRY_CODES3 = [
     ...
     * @var array
     */
    protected $GEOIP_CONTINENT_CODES = [
     ...
     * @var int
     */
    protected $GEOIP_COUNTRY_BEGIN = 16776960;

    /**
     * @var int
     */
    protected $GEOIP_STATE_BEGIN_REV0 = 16700000;

    /**
     * @var int
     */
    protected $GEOIP_STATE_BEGIN_REV1 = 16000000;

    /**
     * @var int
     */
    protected $GEOIP_STANDARD = 0;

    /**
     * @var int
     */
    protected $GEOIP_MEMORY_CACHE = 1;

    /**
     * @var int
     */
    protected $GEOIP_SHARED_MEMORY = 2;

    /**
     * @var int
     */
    protected $STRUCTURE_INFO_MAX_SIZE = 20;

    /**
     * @var int
     */
    protected $DATABASE_INFO_MAX_SIZE = 100;

    /**
     * @var int
     */
    protected $GEOIP_COUNTRY_EDITION = 106;

    /**
     * @var int
     */
    protected $GEOIP_PROXY_EDITION = 8;

    /**
     * @var int
     */
    protected $GEOIP_ASNUM_EDITION = 9;

    /**
     * @var int
     */
    protected $GEOIP_NETSPEED_EDITION = 10;

    /**
     * @var int
     */
    protected $GEOIP_REGION_EDITION_REV0 = 112;

    /**
     * @var int
     */
    protected $GEOIP_REGION_EDITION_REV1 = 3;

    /**
     * @var int
     */
    protected $GEOIP_CITY_EDITION_REV0 = 111;

    /**
     * @var int
     */
    protected $GEOIP_CITY_EDITION_REV1 = 2;

    /**
     * @var int
     */
    protected $GEOIP_ORG_EDITION = 110;

    /**
     * @var int
     */
    protected $GEOIP_ISP_EDITION = 4;

    /**
     * @var int
     */
    protected $SEGMENT_RECORD_LENGTH = 3;

    /**
     * @var int
     */
    protected $STANDARD_RECORD_LENGTH = 3;

    /**
     * @var int
     */
    protected $ORG_RECORD_LENGTH = 4;

    /**
     * @var int
     */
    protected $MAX_RECORD_LENGTH = 4;

    /**
     * @var int
     */
    protected $MAX_ORG_RECORD_LENGTH = 300;

    /**
     * @var int
     */
    protected $GEOIP_SHM_KEY = 0x4f415401;

    /**
     * @var int
     */
    protected $US_OFFSET = 1;

    /**
     * @var int
     */
    protected $CANADA_OFFSET = 677;

    /**
     * @var int
     */
    protected $WORLD_OFFSET = 1353;

    /**
     * @var int
     */
    protected $FIPS_RANGE = 360;

    /**
     * @var int
     */
    protected $GEOIP_UNKNOWN_SPEED = 0;

    /**
     * @var int
     */
    protected $GEOIP_DIALUP_SPEED = 1;

    /**
     * @var int
     */
    protected $GEOIP_CABLEDSL_SPEED = 2;

    /**
     * @var int
     */
    protected $GEOIP_CORPORATE_SPEED = 3;

    /**
     * @var int
     */
    protected $GEOIP_DOMAIN_EDITION = 11;

    /**
     * @var int
     */
    protected $GEOIP_COUNTRY_EDITION_V6 = 12;

    /**
     * @var int
     */
    protected $GEOIP_LOCATIONA_EDITION = 13;

    /**
     * @var int
     */
    protected $GEOIP_ACCURACYRADIUS_EDITION = 14;

    /**
     * @var int
     */
    protected $GEOIP_CITYCOMBINED_EDITION = 15;

    /**
     * @var int
     */
    protected $GEOIP_CITY_EDITION_REV1_V6 = 30;

    /**
     * @var int
     */
    protected $GEOIP_CITY_EDITION_REV0_V6 = 31;

    /**
     * @var int
     */
    protected $GEOIP_NETSPEED_EDITION_REV1 = 32;

    /**
     * @var int
     */
    protected $GEOIP_NETSPEED_EDITION_REV1_V6 = 33;

    /**
     * @var int
     */
    protected $GEOIP_USERTYPE_EDITION = 28;

    /**
     * @var int
     */
    protected $GEOIP_USERTYPE_EDITION_V6 = 29;

    /**
     * @var int
     */
    protected $GEOIP_ASNUM_EDITION_V6 = 21;

    /**
     * @var int
     */
    protected $GEOIP_ISP_EDITION_V6 = 22;

    /**
     * @var int
     */
    protected $GEOIP_ORG_EDITION_V6 = 23;

    /**
     * @var int
     */
    protected $GEOIP_DOMAIN_EDITION_V6 = 24;

    /**
     * @var int
     */
    protected $CITYCOMBINED_FIXED_RECORD = 7;
     ...
     * @return bool|mixed
     */
    protected function _geoip_seek_country($ipnum)
    {
        $offset = 0;
     ...
     */
    protected function _setup_segments()
    {
